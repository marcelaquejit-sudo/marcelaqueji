...
export default function SiteFooter() {
  return (
    <footer id="footer" className="relative mt-24 bg-transparent">
        ...
        <div className="rounded-2xl bg-white/80 backdrop-blur border border-white/60 shadow-[0_10px_30px_rgba(0,0,0,0.08)] px-6 py-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <a href="#hero" className="inline-flex items-center gap-3" aria-label="Voltar ao início">
              <img src="https://i.imgur.com/2SShxU3.png" alt="Marcela Queji" className="h-8 w-auto md:h-9 select-none" />
            ...
            <div className="flex items-center gap-4 text-gray-800">
              <a href="https://wa.me/5542920015594" target="_blank" rel="noopener noreferrer" aria-label="Falar no WhatsApp" className="hover:opacity-80 transition-opacity">
                <svg width="22" height="22" viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M20.52 3.48..."/></svg>
              </a>
              <a href="https://instagram.com/marcelaqueji" target="_blank" rel="noopener noreferrer" aria-label="Abrir Instagram" className="hover:opacity-80 transition-opacity">
                <svg width="22" height="22" viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M7 2..."/></svg>
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 text-xs text-gray-600">
            ...
            <button onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })} className="inline-flex items-center gap-1 hover:text-gray-900" aria-label="Voltar ao topo">
              ↑ Topo
            </button>
          </div>
        </div>
