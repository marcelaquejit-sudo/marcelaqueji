...
export default function CasesShowcase() {
  ...
  return (
    <section
      id="cases"
      className="relative w-full min-h-[90vh] overflow-hidden flex flex-col items-center justify-center px-6 py-24 scroll-mt-24"
    >
      ...
      <div className="absolute inset-0">
        {baseCards.map((c, idx) => (
          ...
          >
            ...
            {/* Subtle hover helpers (sem overlay de faixa): */}
