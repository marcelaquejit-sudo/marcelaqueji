// src/components/Services3DPanel.tsx
...
export default function Services3DPanel() {
  ...
  return (
    <section
      id="servicos"
      className="relative w-full min-h-[90vh] overflow-hidden text-gray-700 flex flex-col lg:flex-row items-center justify-center gap-8 px-6 py-16 scroll-mt-24"
    >
